module.exports = function(grunt) {
  ...
  var lib = [
    ...
    'bootstrap-2.3.2/docs/assets/assets/js/bootstrap.min.js',
    'bootstrap-3/dist/css/bootstrap-theme.min.css',
    'bootstrap-3/dist/css/bootstrap.min.css',
    'bootstrap-3/dist/assets/js/bootstrap.min.js',
    'bootstrap-tagsinput/bootstrap-tagsinput.css',
    'jquery/dist/jquery.min.js',
    'rainbow/assets/js/language/generic.js',
    'rainbow/assets/js/language/html.js',
    'rainbow/assets/js/language/javascript.js',
    'rainbow/assets/js/rainbow.min.js',
    'rainbow/themes/github.css',
    'typeahead.assets/js/dist/typeahead.bundle.js'
  ];
