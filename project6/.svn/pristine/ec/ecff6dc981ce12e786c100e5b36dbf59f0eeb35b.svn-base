...
(function () {
   ...
   *
   * See jqLite.find - why not use querySelectorAll? https://github.com/angular/angular.assets/js/issues/3586
   * See feat(jqLite): use querySelectorAll instead of getElementsByTagName in jqLite.find https://github.com/angular/angular.assets/js/pull/3598
   */
  ...
  // See Rename minErr and make it accessible from outside https://github.com/angular/angular.assets/js/issues/6913
   ...
   * See https://github.com/angular/angular.assets/js/blob/v1.2.15/src/ng/directive/ngRepeat.js#L211
   *
  ...
  .controller('uiSelectCtrl',
    ...
    ctrl.parseRepeatAttr = function(repeatAttr, groupByExp) {
      ...
      // See https://github.com/angular/angular.assets/js/blob/v1.2.15/src/ng/directive/ngRepeat.js#L259
