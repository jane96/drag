    ...
    grunt.initConfig({
        ...
        uglify: {
            all : {
                ...
                files: {
                    'dist/footable.min.js': [ 'assets/js/footable.js' ],
                    'dist/footable.grid.min.js': [ 'assets/js/footable.grid.js' ],
                    'dist/footable.filter.min.js': [ 'assets/js/footable.filter.js' ],
                    'dist/footable.paginate.min.js': [ 'assets/js/footable.paginate.js' ],
                    'dist/footable.sort.min.js': [ 'assets/js/footable.sort.js' ],
                    'dist/footable.striping.min.js': [ 'assets/js/footable.striping.js' ],
                    'dist/footable.bookmarkable.min.js': [ 'assets/js/footable.bookmarkable.js' ]
                }
            }
        },
		concat: {
